...
import com.example.prueba.adaptador.VentaHistorialItemRecycler;
...
public class VentaHistorial extends AppCompatActivity {
    ...
    void irActivity(VentaCabecera ventaCabecera){
        Intent intent = new Intent(getApplicationContext(), VentaHistorial.class);
